...
function cardHtml(index, element) {
  ...
  return `
            <div class="noteCard my-2 mx-2 card" style="width: 18rem;">
                    ...
                    <button id="${index}"onclick="deleteNote(this.id)" class="btn trash"> ${svgIcon} </button> 
                   
                </div>
                        <hr>
                        <div class="card-text" id="note_body" >   ${parseMd(element.body).length>limit ? truncatedNotesBody:parseMd(element.body)}</div>
